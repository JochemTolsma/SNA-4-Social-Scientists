...
We already introduced egonets in section \@ref(types). We defined an egonet as the **set of ties surrounding sampled individual units.** [cf. @marsden1990]. Thus we have an ego with ties to one or more alters. If we also know the ties between our alters we may observe triads. In the figure below I have made the <span style='color: green;'>triad green</span>.   
...
<div class="figure">
<img src="Capture.png" alt="Original Triad census by Davis and Leinhard (1967)" width="50%" />
