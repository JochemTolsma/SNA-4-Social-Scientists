...
```{r , echo=FALSE, , eval=TRUE, fig.cap="Original Triad census by Davis and Leinhard (1967)", out.width = '100%'}
...
```{r, echo=FALSE, fig.cap="1.5 degree co-author egonetwork of JOCHEM TOLSMA"}
...
```{r, echo=FALSE, fig.cap="1.5 degree co-author egonetwork of BAS HOFSTRA"}
#make igraph object
...
```{r, echo=FALSE, , eval=TRUE, fig.cap="Different densities?", out.width = '100%'}
