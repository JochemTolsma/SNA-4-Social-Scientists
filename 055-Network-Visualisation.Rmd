...
detach(package:sna,unload=TRUE) #I will detach this package again, otherwise it will interfere with all kind of functions from igraph, and my students will hate me for that.
```
...
net1_mat <- as_adjacency_matrix(net1, sparse = FALSE)
...
layout(plot(clp, net_sel, margin=c(0,0,0,0) ))
