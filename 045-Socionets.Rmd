...
ans <- ts_estim(net1 = s501, net2 = s502, statistics=list(ts_degree, ts_recip), p2step=c(1,0,0), conv=0.01, verbose=FALSE)
```
...
```{r, echo=FALSE}
ans <- fload("./data/processed/20231003ansestim.rda")
```
