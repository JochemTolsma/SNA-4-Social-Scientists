...
#get_scholar_id_fix("Tom van der Meer")
#fcollabs("l8aM4jAAAAAJ")
#K51iiIAAAAAJ
...
Bas' transitivity network in his network turns out to be: `r round(igraph::transitivity(G2c, type = c("localundirected"), vids = "Bas Hofstra", weights = NULL, isolates = c("NaN", "zero")),2)`. 

Jochem's transitivity in his network turns out to be: `r round(igraph::transitivity(G1c, type = c("localundirected"), vids = "Jochem Tolsma",  weights = NULL, isolates = c("NaN", "zero")) ,2)`.   
