...
scroll_box(knitr::kable(soc_staff_cit, booktabs = TRUE, caption="Sociology staff citation by time") , height="300px")
```
...
for (i in 1:length(collabs_1deep_unique)) {
  ...
  if (!collabs_1deep_unique[i]  %in%  unique(collabs_1deep[,2]) & !collabs_1deep_unique[i] %in% soc_df$gs_id) { # note the if not in...and in...
